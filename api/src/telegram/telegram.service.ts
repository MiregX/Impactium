<<<<<<< Updated upstream:api/libs/mcs/src/telegram/telegram.service.ts
...
import { AuthPayload } from 'src/auth/addon/auth.entity';
import { dataset } from 'src/redis/redis.dto';
import { RedisService } from 'src/redis/redis.service';
import { Configuration } from '../configurator';
>>>>>>> Stashed changes:api/src/telegram/telegram.service.ts
